...
Future<Stream<String>> _server() async {
  ...
  HttpServer server =
      await HttpServer.bind(InternetAddress.LOOPBACK_IP_V4, 8000);
...
Future<Token> getToken(String appId, String appSecret) async {
  ...
  String url =
      "https://www.facebook.com/dialog/oauth?client_id=$appId&redirect_uri=http://localhost:8000/&scope=public_profile";
